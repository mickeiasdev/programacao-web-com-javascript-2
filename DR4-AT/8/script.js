...
// Indique se deve haver segundo turno da eleição e quais serão as duas chapas a concorrer no segundo turno caso alguma das chapa
// não consiga mais de 50% dos votos totais no primeiro turno (faça outro alert para isto). 
